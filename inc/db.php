...
function seed(PDO $pdo): void
{
    ...
    if ($count === 0) {
        $rows = [
            ['Sea Esta', 'villa', 'Mount Lavinia', 'Lead development', 'chapter-04.jpg',
             'Six beachfront villas where the ocean is the fifth wall. Our flagship land-to-handover development.', 1, 1],
            ['Dune House', 'house', 'Bentota', 'Completed', 'chapter-02.jpg',
             'A single-family home folded into a coastal dune, built entirely in-house.', 0, 2],
            ['Palmyra Residences', 'house', 'Negombo', 'In construction', 'chapter-03.jpg',
             'A row of courtyard homes shaded by the palms that were already there.', 0, 3],
            ['The Reef Hotel', 'hotel', 'Unawatuna', 'In design', 'chapter-01.jpg',
             'A boutique reef-front hotel, from the land purchase to the front desk.', 0, 4],
            ['Galle Face Offices', 'commercial', 'Colombo 03', 'Completed', 'chapter-02.jpg',
             'A workplace that reads as calm, delivered on one contract.', 0, 5],
            ['Cinnamon Court', 'villa', 'Ahangama', 'Completed', 'chapter-04.jpg',
    ...
    if ($count === 0) {
        $rows = [
            ['One team, one line of accountability', 'one-team', 'Notes', 'chapter-03.jpg',
             ...
             'live', '2026-08-20'],
            ['What a beachfront plot really costs', 'beachfront-plot-cost', 'Guides', 'chapter-01.jpg',
             ...
             'live', '2026-07-11'],
            ['From flat plan to full model', 'plan-to-model', 'Press', 'chapter-02.jpg',
