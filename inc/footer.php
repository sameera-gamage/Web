...
<footer class="footer" id="footer">
  <div class="footer-cta">
    ...
    <span class="script">start your</span>
  ...
  <div class="footer-grid">
    <div class="footer-col">
      <div class="footer-tag"><?= e(SITE_NAME) ?></div>
      <p class="muted" style="color:#B9C2C6"><?= e(SITE_TAGLINE) ?></p>
    </div>
    <div class="footer-col">
      <p class="footer-label">Pages</p>
      <?php foreach (nav_items() as [$label, $href]): ?><a href="<?= e($href) ?>"><?= e($label) ?></a><?php endforeach; ?>
    </div>
    <div class="footer-col">
...
<a class="fab" href="https://wa.me/<?= e(SITE_PHONE_RAW) ?>" target="_blank" rel="noopener" aria-label="WhatsApp">
